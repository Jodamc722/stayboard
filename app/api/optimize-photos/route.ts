...
1. UNIT FIRST (most important): the early photos MUST showcase the ACTUAL UNIT the guest stays in - its INTERIOR: living, kitchen, bedrooms, bathrooms, and the unit's own balcony/view. The host's COVER is already #1. Your FIRST 1-2 photos should be the strongest INTERIOR highlights of the unit (a bright open living area, a beautiful kitchen, a great primary bedroom, the unit's own view) - do NOT lead with a building exterior or a shared amenity.
2. After those highlights, walk the UNIT logically: living/dining -> kitchen -> primary bedroom -> other bedrooms -> bathrooms -> the unit's own outdoor/balcony. ONLY AFTER every one of the unit's own rooms has been shown do you place building EXTERIOR shots and SHARED amenities (lobby, gym, pool, grounds, hallways, parking). Never put exterior or shared-amenity photos ahead of the unit's interior - they are secondary and belong later in the set.
3. GROUP rooms of the same type together; do NOT scatter (no bedroom, then kitchen, then another bedroom). The flow should feel like a sensible tour of the unit, not a shuffle.
