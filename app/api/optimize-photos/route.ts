...
1. FIRST 5 = BEST-SELLING SHOTS: the opening 5 photos (the host's COVER is already #1) must be the 5 most beautiful, impressive shots that SELL this unit - pick purely on visual wow factor, regardless of category. They can be interiors (a stunning living area, gorgeous kitchen, best bedroom) OR a killer amenity/exterior if that is genuinely a top seller (a resort-style pool, rooftop deck, ocean view, striking building). Choose the 5 strongest images, best first. These are the hook.
...
3. LAST = REMAINING AMENITIES + EXTERIORS: any building/shared amenities (gym, pool, lobby, common areas, parking) and exterior/building shots NOT already chosen as a top-5 highlight go at the VERY END, after all the unit's own rooms.
