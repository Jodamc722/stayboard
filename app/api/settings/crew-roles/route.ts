...
type Person = {
  ...
  /** false = office / coordination — shown on tasks, never the predominant doer (migration 068). */
  field?: boolean
...
export async function GET(req: NextRequest) {
  ...
  for (const n of Object.keys(byName)) {
    ...
    p.field = sr ? sr.field !== false : true
...
export async function PUT(req: NextRequest) {
  ...
  for (const rawName of Object.keys(staffEdits)) {
    ...
    if ('field' in e) patch.field = e.field !== false
