  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-app px-4">
      <div className="max-w-md w-full rounded-2xl border border-line bg-white p-6 text-center">
        ...
        <p className="text-sm text-muted mt-2">Your account isn&apos;t on the Lighthouse access list yet, or it has been disabled. Please ask an admin to grant you access.</p>
