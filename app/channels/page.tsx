      ...
      {rows.length === 0 ? (
        ...
        <>
          ...
          <div className="mt-4 rounded-xl border border-line bg-white px-4 py-3 text-[12px] text-muted">
            ...
            {' '}<span className="block mt-1.5">In plain English: <b className="text-ink">Revenue share</b> = how much of total revenue this channel drives · <b className="text-ink">Booking volume</b> = how many bookings it brings vs your busiest channel · <b className="text-ink">ADR</b> = average nightly rate (revenue ÷ nights) · <b className="text-ink">Cancellation</b> = how often its bookings cancel · <b className="text-ink">Review rating / reply rate</b> = guest scores and how many you’ve replied to.</span>
