...
function cleanTimeCls(bedrooms: number | null | undefined, mins: number): string { const max = bedrooms == null ? 120 : bedrooms <= 0 ? 90 : bedrooms === 1 ? 90 : bedrooms === 2 ? 120 : 180; return mins > max ? 'text-amber-700 bg-amber-50 border-amber-200' : 'text-emerald-700 bg-emerald-50 border-emerald-200' }
