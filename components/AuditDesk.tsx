...
const KIND_CLS: Record<string, string> = { maintenance: 'bg-amber-100 text-amber-800 border-amber-300', clean: 'bg-purple-100 text-purple-800 border-purple-300', replace: 'bg-rose-100 text-rose-700 border-rose-300', add: 'bg-sky-100 text-sky-800 border-sky-300', faq: 'bg-indigo-100 text-indigo-800 border-indigo-300', inventory: 'bg-neutral-100 text-neutral-700 border-neutral-300' }
const KIND_LABEL: Record<string, string> = { maintenance: 'Fix', clean: 'Clean', replace: 'Replace', add: 'Add', faq: 'FAQ', inventory: 'Inventory' }
