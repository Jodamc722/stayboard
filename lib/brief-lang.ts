...
const ES: Record<string, string> = {
  ...
  'Today': 'Hoy',
  // Ops brief revamp (2026-09-07): cleans → who's cleaning → ops → maintenance.
  'Departure cleans': 'Limpiezas de salida',
  'Departure cleans — in order': 'Limpiezas de salida — en orden',
  "Who's cleaning — the field team, in order": 'Quién limpia — el equipo de campo, en orden',
  'Ops today': 'Operaciones hoy',
  "Maintenance — today's run, by technician": 'Mantenimiento — el recorrido de hoy, por técnico',
  'Office — coordination, not a field run': 'Oficina — coordinación, no es recorrido de campo',
  'office': 'oficina',
  'task': 'tarea',
  'tasks': 'tareas',
  'job': 'trabajo',
  ...
  'No departure cleans today.': 'No hay limpiezas de salida hoy.',
  'Nothing on the maintenance board today.': 'Nada en el tablero de mantenimiento hoy.',
  'Same-day turns first, then by unit. The name in bold is who the clean is on; anyone else on the task is listed with them. A crew tag means another crew is covering the turn.':
    'Primero las entradas del mismo día, luego por unidad. El nombre en negrita es quien tiene la limpieza; los demás en la tarea aparecen a su lado. Una etiqueta de equipo significa que otro equipo cubre la limpieza.',
  'A numbered row on a technician is a departure clean he is covering. Bulleted rows are the maintenance board.':
    'Una fila numerada en un técnico es una limpieza de salida que está cubriendo. Las filas con viñeta son el tablero de mantenimiento.',
  'Yesterday': 'Ayer',
  ...
  'empty': 'vacías',
  // ── tiles, verdict and the priority lines
  'Cleans': 'Limpiezas',
  'Unassigned': 'Sin asignar',
  'check-outs': 'salidas',
  'in': 'entran',
  ...
  'same-day turns today': 'salidas con llegada hoy',
  'same-day turn today': 'salida con llegada hoy',
  'guest lands the same day — these doors first:': 'el huésped llega el mismo día — estas unidades primero:',
  'walk-in arriving today': 'llegada sin reserva previa hoy',
  'Booked last minute — confirm the unit is guest-ready.': 'Reservó a último momento — confirme que la unidad esté lista.',
  'open guest issue': 'problema de huésped abierto',
  'pre-arrival inspection': 'inspección antes de la llegada',
  'lands': 'llega',
  'With': 'Con',
