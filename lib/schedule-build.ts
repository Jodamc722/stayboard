// THE SCHEDULE BUILDER — moved out of app/api/schedule/route.ts on 2026-09-03 so the public team
// scheduler link (/team-schedule/<code>) can build the same week the signed-in board sees. The
// route is now a thin auth wrapper around buildSchedule(); nothing about the computation changed.
...
export async function buildSchedule(viewParam: string | null, dateParam: string | null): Promise<any> {
