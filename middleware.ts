...
export async function middleware(request: NextRequest) {
  ...
  const isOpenPath = path.startsWith('/login') || path.startsWith('/auth') || path.startsWith('/signup') || path === '/no-access' || path.startsWith('/api') || path.startsWith('/g/') || path.startsWith('/guide/') || path.startsWith('/r/') || path.startsWith('/audit/') || path.startsWith('/field/') || path.startsWith('/approve/') || path.startsWith('/new-order') || path.startsWith('/vendor/') || path.startsWith('/delivery') || path.startsWith('/owner-orders') || path.startsWith('/salato/share') || path.startsWith('/report/') || path === '/manifest.json' || path.startsWith('/favicon') || path === '/robots.txt'
