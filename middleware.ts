...
export async function middleware(request: NextRequest) {
  ...
  const isOpenPath = path.startsWith('/login') || path.startsWith('/auth') || path.startsWith('/signup') || path === '/no-access' || path.startsWith('/api') || path.startsWith('/g/') || path.startsWith('/audit/') || path.startsWith('/vendor/') || path.startsWith('/delivery') || path.startsWith('/salato/share') || path === '/manifest.json' || path.startsWith('/favicon') || path === '/robots.txt'
